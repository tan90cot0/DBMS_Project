...
SECRET_KEY = 'django-insecure-n#k*tbqr^mo!&e0d1rlw*lodunsvj-+yo$tl37%tzo!3vf65!4'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [Path(BASE_DIR, 'covid/static')]
STATIC_ROOT = Path(BASE_DIR, 'covid/assets')
